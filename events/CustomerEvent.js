...
const customerBookingCreated =
    eventEmitter.addListener("booking.created", async (booking) => {
...
const customerBookingUpdate =
    eventEmitter.addListener("booking.updated", async (booking) => {
      await sendEmail(booking.customer.email,
